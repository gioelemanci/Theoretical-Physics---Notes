...
\end{equation}
also called the restricted Lorentz group. By relativistic invariance, one generically refers to an invariance under the latter; parity and time reversal are usually treated separately.
...
Its unitary irreducible representations are infinite-dimensional and have been classified by Wigner in 1939. They are classified according to the values of the so-called \textbf{Casimir operators} of the Poincaré algebra:
\begin{equation}
    \begin{dcases}
        C_1 = P^2 = P^\mu P_\mu, \\
        C_2 = W^2 = W^\mu W_\mu,
    \end{dcases}
    \label{eq:Poincare_Casimir_operators}
\end{equation}
where
\begin{equation}

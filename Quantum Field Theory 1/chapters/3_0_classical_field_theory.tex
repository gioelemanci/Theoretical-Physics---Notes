...
\end{equation}
The Hamiltonian is then obtained through a \textit{Legendre transformation} of the Lagrangian density:
\begin{equation}
    H = \int \mathrm{d}^3 x\, \mathcal{H},
    \qquad
    \mathcal{H} = \pi^i\dot{\psi}_i - \mathcal{L},
    \label{eq:hamiltonian_density_legendre}
\end{equation}

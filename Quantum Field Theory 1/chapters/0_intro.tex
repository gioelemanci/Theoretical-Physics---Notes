...
\section*{The Poincaré Group and Relativistic Symmetry}
...
\section*{Towards Interacting Theories}
...
Within this framework one computes observable quantities such as decay rates, which measure the probability per unit time that an unstable particle decays, and cross sections, which quantify the likelihood of scattering processes.  

...
Let us consider the most general fusion rule between two arbitrary primary fields \(\phi_{r_1, s_1}\) and \(\phi_{r_2, s_2}\) belonging to the Kac table of a unitary minimal model \(\mathcal{M}_m\) (where the central charge parameter is \(m\)).

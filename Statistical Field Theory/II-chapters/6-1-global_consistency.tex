...
\[
    \mathcal{H}_c = \bigoplus_{h, \bar{h}} \mathcal{N}_{h,\bar{h}} \, \mathcal{L}_{c,h} \otimes \mathcal{L}_{c,\bar{h}}.
\]
Because the trace is a linear operator, it perfectly factorizes over this direct sum:
\[
    Z(q, \bar{q}) = \sum_{h, \bar{h}} \mathcal{N}_{h,\bar{h}} \, \mathrm{Tr}_{\mathcal{L}_{c,h}} \left[ q^{L_0 - \frac{c}{24}} \right] \cdot \mathrm{Tr}_{\mathcal{L}_{c,\bar{h}}} \left[ \bar{q}^{\bar{L}_0 - \frac{c}{24}} \right].
\]
...
\[
    \chi_h (\tau+1) = \mathrm{Tr}_{\mathcal{L}_{c,h}} \left( q^{L_0 - \frac{c}{24}} e^{2\pi i \left(L_0 - \frac{c}{24}\right)} \right).
\]

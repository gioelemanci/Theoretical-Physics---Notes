...
\[
  Z = \sum_{\{s_i\}} e^{-\beta H[\{s_i\}]} = \sum_{\{s_i\}} e^{\beta h \sum_{i}  s_i} = {2 \cosh(\beta h)}^N.
\]
...
\[
  \begin{aligned}
    Z & = \sum_{\{s_i\}} e^{-\beta H[\{s_i\}]}                                                                                                                 \\
      & = \sum_{\{\sigma_k\}} \sum_{\{s_i\}} \left[\prod_{k} \delta\left(\sigma_k - \frac{1}{M} \sum_{j = kM}^{M(k+1)} s_j\right)\right] e^{-\beta H[\{s_i\}]} \\
...
\[
  \begin{aligned}
    Z & = \sum_{\{\sigma_k\}} \sum_{\{s_i\}} \left[\prod_{k} \delta\left(\sigma_k - \frac{1}{M} \sum_{j = kM}^{M(k+1)} s_j\right)\right] e^{\beta h \sum_i s_i}                          \\
      & = \sum_{\{\sigma_k\}} \sum_{\{s_i\}} \left[\prod_{k} \delta\left(\sigma_k - \frac{1}{M} \sum_{j = kM}^{M(k+1)} s_j\right)\right] e^{\beta M h \sum_k \sigma_k}                   \\
...
\[
  \Phi(m(\mathbf{x}), \nabla m(\mathbf{x}), \nabla^2 m(\mathbf{x}), \dots) = a_1 + a_2 m^2(\mathbf{x}) + \dots + \sum_{k} b_k \partial_{x_k} m(\mathbf{x}) \dots
\]
...
\[
  Z = \int \mathcal{D} m(\mathbf{x}) e^{-\int \mathrm{d}^d \mathbf{x}\, \left[ \frac{t}{2} m^2(\mathbf{x}) + u m^4(\mathbf{x}) + \frac{\kappa}{2} (\nabla m(\mathbf{x}))^2 - h m(\mathbf{x})\right]}.
\]
...
\[
  \int \mathrm{d}^d \mathbf{x}\, \left[ \frac{t}{2} m^2(\mathbf{x}) + u m^4(\mathbf{x}) + \frac{\kappa}{2} (\nabla m(\mathbf{x}))^2 - h m(\mathbf{x})\right],
\]
...
\[
  Z \simeq e^{-L^d \left[ \frac{t}{2} m^{*2} + u m^{*4} - h m^*\right]},
\]

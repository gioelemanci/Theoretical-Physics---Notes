...
\[
    \begin{aligned}
        \frac{\partial f}{\partial t} & \sim d \vert t \vert^{d-1} g\left(\frac{h}{\vert t \vert^{\Delta}}\right) - \Delta \vert t \vert^{d-\Delta-1} h g^{\prime}\left(\frac{h}{\vert t \vert^{\Delta}}\right)                  \\
                                      ...
                                      & = \, : \vert t \vert^{d-1} \tilde{g}\left(\frac{h}{\vert t \vert^{\Delta}}\right),
    \end{aligned}
\]
...
\[
    C \propto - \frac{\partial^2}{\partial t^2} f \sim \vert t \vert^{-d-2} \tilde{\tilde{g}}\left(\frac{h}{\vert t \vert^{\Delta}}\right),
\]
...
\[
    C(t, h=0) \xrightarrow{t \to 0} \vert t \vert^{d-2} \tilde{\tilde{g}}(0) = \text{const} \cdot \vert t \vert^{d-2}.
\]

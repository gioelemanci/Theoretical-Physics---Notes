...
\[
    \begin{aligned}
        \mathcal{Z} & = \sum_{\{s^{\prime}_i\}_{i=0}^{n'}} \sum_{\{s_i\}_{i=1}^N} e^{\sum_{i} B(s_{i}, s_{i+1})} \prod_{i=0}^{n'} \delta(s_i^{\prime}, s_{2i+1})                                                                                    \\
                    & = \sum_{\{s^{\prime}_i\}_{i=0}^{n'}} \prod_{i=0}^{n'} e^{ \sum_{i=1}^{N/2} \left( B(s_{2i+1}, s_{2i+2}) + B(s_{2i+2}, s_{2i+3}) \right) } \prod_{i=0}^{n'} \delta(s_i^{\prime}, s_{2i+1})                                     \\
                    & = \sum_{\{s^{\prime}_i\}_{i=0}^{n'}} \sum_{\{s_{2i+2}\}_{i=1}^{N/2}} e^{\sum_i^{N/2} B(s_i^{\prime}, s_{2i+2}) + B(s_{2i+2}, s_{i+1}^{\prime})} = \sum_{\{s^{\prime}_i\}_{i=0}^{n'}} e^{-\beta H^{\prime}[\{s_i^{\prime}\}]},
    \end{aligned}
\]
...
\[
    2^{\ell/2}e^{-k} = 1 \quad \implies \quad \ell = 2k,
\]

...
\[
    \left\langle \frac{1}{N} \sum_{i} s_i \right\rangle_c = \frac{1}{N} \sum_{\{s_i\}} \left( \sum_{i} s_i \right) \frac{e^{-\beta H(\{s_i\})}}{Z},
\]
...
\[
    \begin{aligned}
        \left\langle \frac{1}{N} \sum_{i} s_i \right\rangle_c & = \sum_{m \in [-1, \ldots, +1]} m \sum_{\{s_i\}} \delta\left(\sum_{i} s_i - Nm\right) \frac{e^{-\beta H_{mf}(m)}}{Z} \\
...
\[
    \left\langle \frac{1}{N} \sum_{i} s_i \right\rangle_c = \frac{1}{Z} \sum_{m} m e^{-\beta N f(m)} = \frac{1}{Z} \sum_{m} m e^{-\beta H_{mf}(m)} \Omega(m),
\]

...
\[
    \left\langle s_i \right\rangle_c = m = -\frac{1}{N} \frac{\partial}{\partial h} \log Z = -\frac{1}{\beta} \frac{\partial}{\partial h} (\frac{F}{N}).
\]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/ising_1d_m-h_plot.png}
...
\[
    \left\langle s_i s_{i+r} \right\rangle = \frac{1}{Z} \sum_{\{s_k\}} s_i s_{i+r} e^{-\beta H(\{s_k\})},
\]
which can become a connected correlation function if we subtract the product of the magnetizations:
\[
    \left\langle s_i s_{i+r} \right\rangle - \left\langle s_i \right\rangle \left\langle s_{i+r} \right\rangle = \frac{1}{Z} \sum_{\{s_k\}} s_i s_{i+r} e^{-\beta H(\{s_k\})} - m^2.
\]
...
\[
    \left\langle s_i s_{i+r} \right\rangle = \frac{1}{Z} \sum_{\alpha_1=1}^2 \sum_{\alpha_2=1}^2 \dots \sum_{\alpha_N=1}^2 \sigma_{\alpha_j} \sigma_{\alpha_{j+r}} T_{\alpha_1, \alpha_2} T_{\alpha_2, \alpha_3} \cdots T_{\alpha_N, \alpha_1},
\]
...
\[
    \left\langle s_j s_{j+r} \right\rangle = \frac{1}{Z} \text{Tr}(T^{j-1} D T^{r} D T^{N-r+1-j}),
\]
...
\[
    \left\langle s_j s_{j+r} \right\rangle_{h=0} =\dots \sim e^{-\tfrac{r}{\xi}},
\]

...
\[
    \frac{\mathrm{d} \sigma_{LO}}{\mathrm{d} \Omega}\big|_{\text{CM}} = \frac{1}{64 \pi^2 E^2_{cm}} \frac{\vert \mathbf{p}_{out} \vert}{\vert \mathbf{p}_{in} \vert} \vert \mathcal{M}_{LO} \vert^2 = \frac{1}{64 \pi^2} \frac{\lambda^2}{s}.
\]

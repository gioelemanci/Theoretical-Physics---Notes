\section*{Sheet 2}
\addcontentsline{toc}{section}{Sheet 2}

\subsection{1. Feynman Diagrams in $\phi^3$ Theory}
\addcontentsline{toc}{subsection}{1. Feynman Diagrams in $\phi^3$ Theory}

[...]


\subsection*{2. Feynman Rules for Scalar QED (sQED)}
\addcontentsline{toc}{subsection}{2. Feynman Rules for Scalar QED (sQED)}
...
\addcontentsline{toc}{subsection}{3. Scattering Amplitude in sQED}
...
\addcontentsline{toc}{subsection}{4. Crossing Symmetry in sQED}
...
\addcontentsline{toc}{subsection}{5. Gamma Matrix Identity in 4D}
...
\addcontentsline{toc}{subsection}{6. Unpolarized scattering of fermions in the Yukawa theory}
...
\addcontentsline{toc}{subsection}{7. Decay of a scalar into a fermion-antifermion pair}
...
\addcontentsline{toc}{subsection}{8. Compton scattering in QED}
...
\addcontentsline{toc}{subsection}{9. Ward identity in sQED}
...
\addcontentsline{toc}{subsection}{10. Scaling Green functions and scattering amplitudes}

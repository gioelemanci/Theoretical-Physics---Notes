...
\subsection*{6. One-loop self-energy in Yukawa theory}
...
\begin{enumerate}[label=\alph*)]
    ...
    \item A scalar tadpole loop from the quartic coupling $\lambda_4$.
    \item A scalar bubble loop from the cubic coupling $\lambda_3$.
\end{enumerate}
Diagrams (b) and (c) correspond to standard scalar integrals computed in previous lectures, leaving the fermion loop (a) as the only new correction to evaluate.

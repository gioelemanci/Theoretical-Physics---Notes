\section*{Sheet 3}
\addcontentsline{toc}{section}{Sheet 3}

\subsection*{1. Euler-Lagrange equations and Functional Derivatives}
\addcontentsline{toc}{subsection}{1. Euler-Lagrange equations and Functional Derivatives}
...
\addcontentsline{toc}{subsection}{2. Deriving Feynman rules of sQED via functional derivatives}
...
\addcontentsline{toc}{subsection}{3. Generating functional for the free Dirac field}
...
\addcontentsline{toc}{subsection}{4. Feynman propagator for a massive spin-1 particle}
...
\addcontentsline{toc}{subsection}{5. Photon Propagator and Gauge Fixing}
...
\addcontentsline{toc}{subsection}{6. Furry's theorem in sQED}
...
\addcontentsline{toc}{subsection}{7. Furry's theorem in QED}
...
\addcontentsline{toc}{subsection}{8. Lightcone axial gauge in QED}
...
\addcontentsline{toc}{subsection}{9. QED Ward-Takahashi identity}

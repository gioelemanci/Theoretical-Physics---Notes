...
\]
which in the thermodynamic limit becomes infinitesimal \(L \to \infty \implies \Delta k_j \to 0\). Therefore, the number of states in a volume element \(\mathrm{d}^{3\mathbf{k}} \) in \(\mathbf{k}\)-space is given by
\[
...
\[
    \begin{aligned}
        ...
        \epsilon = \frac{E}{V} & = A \int_0^{\mu} \d{\epsilon} \epsilon^{3/2} \frac{1}{e^{\beta(\epsilon-\mu)} + 1} = \int_0^{\infty} \d{\epsilon} \epsilon \, g(\epsilon) \langle n(\epsilon) \rangle^{FD}_{gc},
    \end{aligned}
\]
...
\[
    \begin{aligned}
        ...
        \epsilon & = \frac{1}{n} \int_0^{\mu=\epsilon_F} g(\epsilon) \epsilon \cdot 1 \, \mathrm{d} \epsilon = \frac{A}{n} \int_0^{\mu} \epsilon^{3/2} \mathrm{d} \epsilon = \frac{2}{5} \frac{A}{n} \epsilon_F^{5/2} = \frac{3}{5} \epsilon_F.
    \end{aligned}
\]
...
\[
    q = T_{BEC} \Delta s = T_{BEC} s(T_{BEC}) - s(0) = \frac{5}{2} k_B T_{BEC} \frac{\zeta(5/2)}{\zeta(3/2)} \neq 0,
\]

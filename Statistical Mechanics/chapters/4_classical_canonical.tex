...
\[
    ...
    \end{aligned}
\]
practically proving \textit{Boltzmann's universal formula}. Hence, in the thermodynamic limit we have \(s_{mc} = s_c = s_{th}\).
...
\begin{proof}
    ...
    \]
    We can isolate the differential with respect to one variable \(\xi_j\):
    \[

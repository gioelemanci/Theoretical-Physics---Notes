...
In this expression, $\mathbf{p}\cdot\mathbf{x} - Et/c^2 = x_\mu p^\mu$ is the standard relativistic scalar product between the four-momentum and the four-position.

\chapter[Vector calculus in $\mathbb{R}^3$ geometry]{Vector calculus in $\mathbb{R}^3$\\geometry}

\section{Geometric Structures and Identities}

\subsection{Euclidean and Orientational Structure}
...
\subsection{Determinant and Trace Identities}
...
\section{Algebraic Operations and Exterior Algebra}
...
\section{Complexification and Spectral Theory}
